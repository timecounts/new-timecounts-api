const verificationMail = (recieverName, verificationLink) => {
    return {
        ...
        Please verify your email address to get access to thousands of exclusive features of Timecounts.
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td
                                                                      ...
                                                                      <img class="max-width" border="0"
                                                                        style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;"
                                                                        width="95" alt="" data-proportionally-constrained="true"
                                                                        data-responsive="false"
